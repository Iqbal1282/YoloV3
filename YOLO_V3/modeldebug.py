...
def yoloV3(input_layer):
	...
	conv_lbbox = convolutional(conv_lobj_branch,(1,1,1024,3*(NUM_CLASS +5)),
	...
	conv_mbbox = convolutional(conv_mobj_branch, (1,1,512,3*(NUM_CLASS + 5)),
		activate= False, batch_norm = False)
	...
	conv_sbbox = convolutional(conv_sobj_branch, (1, 1, 256, 3*(NUM_CLASS +5)),
		activate=False, batch_norm=False)
